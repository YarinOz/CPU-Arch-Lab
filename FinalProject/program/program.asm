...
main:
    ...
    lw $a0, 0x0001($zero)    # $a0 = DTCM[0x0000] = 2
    addi $a1, $zero, 7       # $a1 = 7
    sw $a1, 0x0002($zero)    # Store 7 in DTCM[0x0002]

    # R-Type Instructions
    sll $t0, $a0, 1          # $t0 = $a0 << 1 = 4
    srl $t1, $a0, 1          # $t1 = $a0 >> 1 = 1
    add $t2, $a0, $a1        # $t2 = $a0 + $a1 = 9
    sub $t3, $a1, $a0        # $t3 = $a1 - $a0 = 5
    mul $t4, $a0, $a1        # $t4 = $a0 * $a1 = 14
    and $t5, $a0, $a1        # $t5 = $a0 & $a1 = 2
    or $t6, $a0, $a1         # $t6 = $a0 | $a1 = 7
    xor $t7, $a0, $a1        # $t7 = $a0 ^ $a1 = 5
    slt $t8, $a0, $a1        # $t8 = ($a0 < $a1) ? 1 : 0 = 1

    # I-Type Instructions
    beq $a0, $a1, skip       # If $a0 == $a1, skip next instruction
    bne $a0, $a1, next       # If $a0 != $a1, go to next
    addi $t9, $a0, 3         # $t9 = $a0 + 3 = 5
    slti $t9, $a0, 4         # $t9 = ($a0 < 4) ? 1 : 0 = 1
    andi $t9, $a0, 1         # $t9 = $a0 & 1 = 0
    ori $t9, $a0, 8          # $t9 = $a0 | 8 = 10
    xori $t9, $a0, 3         # $t9 = $a0 ^ 3 = 1
